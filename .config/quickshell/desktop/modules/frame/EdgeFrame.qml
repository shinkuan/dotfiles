...
Scope {
    ...
    EdgeZone {
        anchors.left: true
        exclusiveZone: (ShellState.barPinned || Theme.barAlways) && !Theme.barTop && !Theme.barRight ? Config.barWidth : Config.borderThickness
    }
    ...
    EdgeZone {
        anchors.right: true
        exclusiveZone: ShellState.barPinned && Theme.barRight ? Config.barWidth : Config.borderThickness
    }
