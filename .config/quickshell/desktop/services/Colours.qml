...
Singleton {
    ...
    // M3 "on*" roles are exposed as *Text: a property named on<X> resolves
    // as a signal-handler lookup inside JS expressions and reads as black.
    ...
    readonly property color surfaceText: c("onSurface", "#e8e1e0")
    readonly property color surfaceVariantText: c("onSurfaceVariant", "#d3c3c0")
    ...
    readonly property color inverseSurfaceText: c("inverseOnSurface", "#33302f")
    readonly property color primary: c("primary", "#e1bfb9")
    readonly property color primaryText: c("onPrimary", "#412b27")
    readonly property color primaryContainer: c("primaryContainer", "#7b605b")
    readonly property color primaryContainerText: c("onPrimaryContainer", "#ffded8")
    readonly property color secondary: c("secondary", "#d5c3bf")
    readonly property color secondaryText: c("onSecondary", "#392e2c")
    readonly property color secondaryContainer: c("secondaryContainer", "#534644")
    readonly property color secondaryContainerText: c("onSecondaryContainer", "#c6b5b1")
    readonly property color tertiary: c("tertiary", "#d4c5a8")
    readonly property color tertiaryText: c("onTertiary", "#392f1b")
    readonly property color tertiaryContainer: c("tertiaryContainer", "#71654d")
    readonly property color tertiaryContainerText: c("onTertiaryContainer", "#f4e3c5")
    readonly property color error: c("error", "#ffb4ab")
    readonly property color errorText: c("onError", "#690005")
    readonly property color errorContainer: c("errorContainer", "#93000a")
    readonly property color errorContainerText: c("onErrorContainer", "#ffdad6")
    readonly property color success: c("success", "#b5ccba")
    readonly property color successText: c("onSuccess", "#213528")
