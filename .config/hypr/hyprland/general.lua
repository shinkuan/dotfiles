...
-- Animations
-- layers map and unmap on a keypress (launcher, polkit, overview): a long
-- fade there just reads as lag, so they are the quickest thing on screen
hl.animation({ leaf = "layersIn",        enabled = true, speed = 0.8, bezier = "emphasizedDecel", style = "fade" })
hl.animation({ leaf = "layersOut",       enabled = true, speed = 0.8, bezier = "emphasizedAccel", style = "fade" })
